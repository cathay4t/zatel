...
pub(crate) enum ZatelIfaceState {
    Up,
    Down,
    Unknown,
}

impl std::convert::From<&IfaceState> for ZatelIfaceState {
...
impl std::convert::From<&Ipv4AddrInfo> for ZatelIpInfo {
...
impl std::convert::From<&Ipv6AddrInfo> for ZatelIpInfo {
...
#[derive(Deserialize, Serialize, Debug, Clone)]
pub(crate) struct ZatelBaseIface {
    pub(crate) name: String,
    pub(crate) iface_type: String,
    pub(crate) state: ZatelIfaceState,
    pub(crate) mtu: i64,
    pub(crate) mac_address: String,
    pub(crate) ipv4: Option<Vec<ZatelIpInfo>>,
    pub(crate) ipv6: Option<Vec<ZatelIpInfo>>,
}

impl std::convert::From<&Iface> for ZatelBaseIface {
